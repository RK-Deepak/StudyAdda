...
import { MdArrowBack, MdArrowDownward, MdArrowDropDown, MdBackHand, MdBackspace } from 'react-icons/md';
...
const VideoSideBar  = ({setReviewModal}) => {
  ...
  return(
    <>
      <div className="flex h-fit md:h-[calc(100vh-3.5rem)] w-full md:w-[320px] md:max-w-[350px] flex-col border-r-[1px] border-r-richblack-700 bg-richblack-800 ">
